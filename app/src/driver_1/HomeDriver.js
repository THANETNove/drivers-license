          ...
          <View style={{ flex: 1, justifyContent: 'center', zIndex: 0 }}>
            ...
            <Pressable style={styles.boxModel3}
              ...
              <Text style={styles.textBoxModel3}>
                {
                  index == 0 ? "รอบรู้เรื่องการสอบใบขับขี่" : index == 1 ? "ทดสอบสมรรณภาพ" : index == 2 ?
                    "ทดสอบพร้อมเฉลย" : index == 3 ? "เเนวข้อสอบพร้อมเฉลย" : index == 4 ? "คลิปสอนสอบฏิบัติ" : index == 5 && "การต่อใบขับขี่"
                }
